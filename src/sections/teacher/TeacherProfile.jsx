...
import { getTeacherProfileAsync } from "../../redux/user/userSlice";
...
const TeacherProfile = () => {
  ...
  useEffect(() => {
    dispatch(getTeacherProfileAsync());
  }, [dispatch]);
  ...
  return (
    <>
      ...
      {isChangePasswordOpen && <ChangePassword role={user?.role} />}
        ...
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-2/3 bg-white shadow-xl rounded-3xl p-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
              ...
              <p>
                <span className="font-medium text-purple-700">Mobile:</span>{" "}
                {user?.mobile || "N/A"}
              </p>
              <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
              ...
              <p>
                <span className="font-medium text-purple-700">Teacher_Id</span>{" "}
                {user?.teacher_id || "N/A"}
              </p>
