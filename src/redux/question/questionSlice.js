...
// import { addQuestionApi, deleteQuestionApi, fetchQuestionsApi } from "../apis/questionApi";
...
// export const deleteQuestionAsync = createAsyncThunk('paper/deleteQuestions',async(id,{rejectWithValue})=>{
//   try{
...
//         state.loading = false;
//         state.error = null;
//         state.allQuestions =state.allQuestions.filter((item)=>(item._id !== action.payload._id));
//       })
