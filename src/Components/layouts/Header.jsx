    ...
    <section className="flex justify-between w-full py-3 items-center font-medium text-gray-700   px-28">
      ...
      <div className=" md:flex gap-8 items-center hidden  ">
        ...
        <div className="flex items-center gap-1 cursor-pointer hover:text-purple-800 hover:font-semibold ">
          {" "}
          <p>Papers</p> <ChevronDown size={16} strokeWidth={2.6} />
        </div>
        <div className="flex items-center gap-1 cursor-pointer  hover:text-purple-800 hover:font-semibold">
          <p>Courses</p>
        ...
        <div className="flex items-center gap-1 cursor-pointer  hover:text-purple-800 hover:font-semibold">
          <p>About Us</p> <ChevronDown size={16} strokeWidth={2.6} />{" "}
        </div>
        <div className="flex items-center gap-1 cursor-pointer text-base hover:text-purple-800 hover:font-semibold">
          <p>Contact Us</p>
          <ChevronDown size={16} strokeWidth={2.6} />{" "}
        </div>
      </div>
